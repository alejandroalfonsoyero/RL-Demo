...
if __name__ == '__main__':
    ...
    greedy.plot_average_reward(plt, "greedy")
    e_greedy_0001.plot_average_reward(plt, "e-greedy (e=0.001)")
    e_greedy_001.plot_average_reward(plt, "e-greedy (e=0.01)")
    e_greedy_01.plot_average_reward(plt, "e-greedy (e=0.1)")
    e_greedy_05.plot_average_reward(plt, "e-greedy (e=0.5)")
